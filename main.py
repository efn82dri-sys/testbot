...
GROUP_RULES_TEXT = (
    "🌱 <b>سلام دوست من</b>\n\n"
    "<blockquote>"
    "همون‌طور که می‌دونید، هدف ما از VIP کردن این فضا این بود که یه پاتوق زنده، "
    "پرانرژی و خلاق برای معمارای واقعی داشته باشیم، نه یه فضای بی‌سروصدا که فقط فایل‌ها "
    "دانلود بشن و کسی با کسی حرف نزنه! 🥱\n\n"
    "برای اینکه اتمسفر گرم و پویای گروهمون حفظ بشه، یه قانون ثابت داریم:\n\n"
    "🤖 <b>سنجش فعالیت توسط ربات:</b>\n"
    "ربات گروه به‌طور هوشمند تعامل بچه‌ها رو ثبت می‌کنه. اگه توی یک هفته (۷ روز) هیچ فعالیتی "
    "(مثل گپ زدن، نظر دادن توی بحث‌ها یا تعامل) نداشته باشید، ربات به این مِتُد حساسه و اکانت رو "
    "به‌طور خودکار از گروه حذف می‌کنه.\n\n"
    "دوست داریم جاتون همیشه اینجا امن و برقرار باشه؛ پس حضور گرمتون رو از "
    "<a href=\"https://t.me/c/4388421316/95\">کافه معماری</a> دریغ نکنید و توی بحث‌ها و "
    "آپدیت‌ها همراهمون باشید. ❤️☕️"
    "</blockquote>"
)
