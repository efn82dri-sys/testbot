...
GROUP_RULES_TEXT = (
    "<b>سلام دوست من</b>\n\n"
    "<blockquote>\n"
    "<b>همون طور که می‌دونید، هدف ما از VIP کردن این فضا این بود که یه پاتوق زنده، پرانرژی و خلاق برای معماری واقعی داشته باشیم، نه یه فضای بی‌سروصدا که فقط فایل‌ها دانلود بشن و کسی با کسی حرف نزنه!</b>\n"
